...
// The Ethereum API allows applications to connect to an Blackfury node that is
// part of the Blackfury blockchain. Developers can interact with on-chain EVM data
