...
# Initialize chain.
blackfuryd init test --chain-id blackfury_9000-2

# Get Genesis
wget https://archive.blackfury.org/mainnet/genesis.json
mv genesis.json ~/.blackfuryd/config/

wget -O ~/.blackfuryd/config/adrbook.json https://snapshot.notional.ventures/blackfury/addrbook.json
...
export BLACKFURYD_P2P_MAX_NUM_INBOUND_PEERS=200
export BLACKFURYD_P2P_MAX_NUM_OUTBOUND_PEERS=200
export BLACKFURYD_STATESYNC_RPC_SERVERS="https://blackfury-rpc.polkachu.com:443,https://rpc-blackfury-ia.notional.ventures:443"
