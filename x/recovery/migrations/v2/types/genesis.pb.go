...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "blackfury.recovery.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "blackfury.recovery.v1.V2Params")
}

func init() { proto.RegisterFile("blackfury/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
