...
// source: blackfury/V2Incentives/v1/genesis.proto
...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "blackfury.V2Incentives.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "blackfury.V2Incentives.v1.V2Params")
}

func init() {
	proto.RegisterFile("blackfury/V2Incentives/v1/genesis.proto", fileDescriptor_7bb1f7c7e8ad160b)
}
