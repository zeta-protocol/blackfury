...
import (
	...
	"github.com/zeta-protocol/blackfury/v13/x/revenue/v1/types"
)
...
func (k Keeper) Revenue(
	...
	if err := blackfurytypes.ValidateNonZeroAddress(req.ContractAddress); err != nil {
...
func (k Keeper) WithdrawerRevenues( //nolint: dupl
	...
	if err != nil {
		return nil, status.Errorf(
			codes.InvalidArgument,
			"invalid format for withdraw addr %s, should be bech32 ('blackfury...')", req.WithdrawerAddress,
		)
	}
