...
func init() {
	...
	proto.RegisterType((*ProposalMetadata)(nil), "blackfury.erc20.v1.ProposalMetadata")
}

func init() { proto.RegisterFile("blackfury/erc20/v1/erc20.proto", fileDescriptor_668d5dc537f45142) }
