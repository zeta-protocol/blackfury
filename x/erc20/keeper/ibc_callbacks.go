...
import (
	...
	"github.com/zeta-protocol/blackfury/v13/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "ablackfury"),
...
func (k Keeper) OnRecvPacket(
	...
	// Get addresses in `blackfury1` and the original bech32 format
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	// assume that all module accounts on Blackfury need to have their tokens in the
