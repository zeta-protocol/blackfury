...
// EthSetup initializes a new BlackfuryApp. A Nop logger is set in BlackfuryApp.
func EthSetup(isCheckTx bool, patchGenesis func(*Blackfury, simapp.GenesisState) simapp.GenesisState) *Blackfury {
	return EthSetupWithDB(isCheckTx, patchGenesis, dbm.NewMemDB())
}

// EthSetupWithDB initializes a new BlackfuryApp. A Nop logger is set in BlackfuryApp.
func EthSetupWithDB(isCheckTx bool, patchGenesis func(*Blackfury, simapp.GenesisState) simapp.GenesisState, db dbm.DB) *Blackfury {
	app := NewBlackfury(log.NewNopLogger(),
		db,
		nil,
		true,
		map[int64]bool{},
