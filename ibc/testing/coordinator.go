...
const DefaultFeeAmt = int64(150_000_000_000_000_000) // 0.15 BLACKFURY
...
func SendMsgs(chain *ibctesting.TestChain, feeAmt int64, msgs ...sdk.Msg) (*sdk.Result, error) {
	...
	if blackfuryChain, ok := chain.App.(*app.Blackfury); ok {
		bondDenom = blackfuryChain.StakingKeeper.BondDenom(chain.GetContext())
	} else {
