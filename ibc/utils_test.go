...
func TestGetReceivedCoin(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			"transfer",
			"channel-0",
			"transfer/channel-0/ablackfury",
			"10",
			sdk.Coin{Denom: "ablackfury", Amount: sdk.NewInt(10)},
		},
		{
...
func TestGetSentCoin(t *testing.T) {
	testCases := []struct {
		...
		{
			"get unwrapped ablackfury coin",
			"ablackfury",
			"10",
			sdk.Coin{Denom: "ablackfury", Amount: sdk.NewInt(10)},
		},
		{
			"get ibc wrapped ablackfury coin",
			"transfer/channel-0/ablackfury",
			"10",
			sdk.Coin{Denom: teststypes.AblackfuryIbcdenom, Amount: sdk.NewInt(10)},
		},
		{
