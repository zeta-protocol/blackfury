...
Please refer to the official Blackfury [bug bounty program](https://immunefi.com/bounty/blackfury/)
...
- Use the Blackfury [bug bounty program](https://immunefi.com/bounty/blackfury/) on Immunefi to disclose all vulnerabilities,
...
Blackfury uses the following disclosure process:
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Blackfury in a
    ...
    4. The nodes and validators update their Blackfury and Ethermint dependencies to use these releases.
    5. A week (or less) after the security vulnerability has been patched on Blackfury,
...
including but not limited to Blackfury,
as secure as possible.

### Payment Process

The payment process will be executed according to Blackfury’s Immunefi Bug Bounty program Rules.

### Contact

The Blackfury Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@blackfury.org](mailto:security@blackfury.org)
