...
for running end-to-end tests on Blackfury.
It is used for testing chain upgrades,
as it allows for initializing multiple Blackfury chains with different versions.
...
This package is decoupled from depending on the Blackfury codebase.
It initializes the chains for testing via Docker.  
As a result, the test suite may provide the
desired Blackfury version to Docker containers during the initialization.
This design allows for the opportunity of testing chain upgrades
by providing an older Blackfury version to the container,
...
```log
ok  	github.com/zeta-protocol/blackfury/v9/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/zeta-protocol/blackfury/v10/cmd/blackfuryd/root.go:243 +0x2ca
        github.com/zeta-protocol/ethermint/server.startInProcess(_, {{0x0, 0x0, 0x0},...
            github.com/zeta-protocol/ethermint@v0.20.0-rc2/server/start.go:304 +0x9c5
        github.com/zeta-protocol/ethermint/server.StartCmd.func2(0xc001620600?, {0xc0...
            github.com/zeta-protocol/ethermint@v0.20.0-rc2/server/start.go:123 +0x1ec
        ...
        main.main()
            github.com/zeta-protocol/blackfury/v10/cmd/blackfuryd/main.go:20 +0x45
