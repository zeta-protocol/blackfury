...
// TestBlackfuryVersionsLess tests the BlackfuryVersions type's Less method with
// different version strings
func TestBlackfuryVersionsLess(t *testing.T) {
	var version BlackfuryVersions
...
// TestBlackfuryVersionsSwap tests the BlackfuryVersions type's Swap method
func TestBlackfuryVersionsSwap(t *testing.T) {
	var version BlackfuryVersions
	value := "v9.1.0"
...
// TestBlackfuryVersionsLen tests the BlackfuryVersions type's Len method
func TestBlackfuryVersionsLen(t *testing.T) {
	var version BlackfuryVersions = []string{"v9.1.0", "v10.0.0"}
