...
import (
	...
	blackfury "github.com/zeta-protocol/blackfury/v13/types"
...
func LegacyEIP712Cmd() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s debug legacy-eip712 tx.json --chain-id blackfuryd_9000-1`, version.AppName),
		Args:    cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			chainID, err := blackfury.ParseChainID(clientCtx.ChainID)
			if err != nil {
