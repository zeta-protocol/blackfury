...
import (
	...
	"github.com/zeta-protocol/blackfury/v13/crypto/hd"
	...
	"github.com/zeta-protocol/blackfury/v13/testutil/network"
)
...
func initTestnetFiles(
	...
	for i := 0; i < args.numValidators; i++ {
		...
		coins := sdk.Coins{
			sdk.NewCoin(blackfurytypes.AttoBlackfury, accStakingTokens),
		}
		...
		createValMsg, err := stakingtypes.NewMsgCreateValidator(
			sdk.ValAddress(addr),
			valPubKeys[i],
			sdk.NewCoin(blackfurytypes.AttoBlackfury, valTokens),
		...
		customAppTemplate, customAppConfig := config.AppConfig(blackfurytypes.AttoBlackfury)
	...
	if err := initGenFiles(clientCtx, mbm, args.chainID, blackfurytypes.AttoBlackfury, genAccounts, genBalances, genFiles, args.numValidators); err != nil {
		return err
	}
