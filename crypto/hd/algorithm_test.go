...
import (
	...
	enccodec "github.com/zeta-protocol/blackfury/v13/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("blackfury", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, blackfurytypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
	...
	hdPath := blackfurytypes.BIP44HDPath
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, blackfurytypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(blackfurytypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Blackfury implementation
	...
	// Equality of Eth and Blackfury implementation
	...
	// Inequality of wrong derivation path of Eth and Blackfury implementation
