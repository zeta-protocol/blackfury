...
import (
	...
	"github.com/zeta-protocol/blackfury-ledger-go/ledger"
	"github.com/zeta-protocol/blackfury/v13/crypto/ethsecp256k1"
	"github.com/zeta-protocol/blackfury/v13/crypto/hd"
)

// AppName defines the Ledger app used for signing. Blackfury uses the Ethereum app
...
var (
	...
	// LedgerDerivation defines the Blackfury Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.BlackfuryLedgerDerivation()
